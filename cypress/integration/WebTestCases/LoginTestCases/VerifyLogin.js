...
describe("Login Functionality", function(){
    ...
    it('Verify Login', function(){
        ...
        cart.clickCartLink().verifyBtnPlaceOrder()
        .clickBtnPlaceOrder();

        checout.verifyPlaceOrderModal()
        .enterName("Tester Ind").enterCountry("India").enterCity("Delhi")
        .enterCardDetail("4485665260077579").enterMonth("04").enterYear("2023")
        .clickPurchaseButton();
